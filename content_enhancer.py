...
2. 모든 이미지 참조와 이미지 설명을 그대로 유지하세요. 단 문서의 주제에 대해 설명이 변경되어 하는 경우에는 수정하세요.
3. 전문 용어가 나오면 괄호 안에 영문 약어(있는 경우)와 함께 이해하기 쉽게 설명을 추가하세요. 예: 인공지능(AI, Artificial Intelligence: 컴퓨터가 인간의 지능을 모방하는 기술)
4. 설명이 부족한 부분이 있다면 더 자세하고 이해하기 쉬운 설명을 추가하세요. 특히 수식에 대해서는 그대로 표현하면서도 어떤 내용인지 해설을 해주세요.
5. 내용의 흐름을 자연스럽게 만들고, 각 섹션 간의 연결을 강화하세요.
6. 복잡한 개념은 일상적인 예시나 비유를 사용하여 설명하세요.
7. 각 주요 개념이나 기술에 대해 실제 응용 사례를 1-2개 추가하세요.
8. 각 섹션의 끝에 해당 섹션의 핵심 내용을 요약하는 1-2문장을 추가하세요.
9. "개선된 버전을 제시하겠습니다:" 와 같은 응답성 메세지는 출력하지 마세요.
